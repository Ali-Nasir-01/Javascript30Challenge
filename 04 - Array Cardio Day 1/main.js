...
const totalTime = inventors.reduce(
  (total, inventor) => total + inventor.passed - inventor.year,
  0
);

console.log("How many years did all the inventors live?", totalTime);
...
const sortedPeoples = people.sort((a, b) => {
  aLast = a.split(",")[0].trim();
  bLast = b.split(",")[0].trim();
...
console.log(transportationInstance);
